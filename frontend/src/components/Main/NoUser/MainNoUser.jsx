...
const MainNoUser = () => {
    ...
    return (
        <div className='mpd'>
            ...
            <PurpleOutlineDiv boldText={'About Heap'} smallText={"We connect buyers with sellers --  it's that simple. But you can click to learn more anyway."} logo={<FaCube className='cube heapPurple' />} css={"purpleOutlineDiv colorDiv lastDiv"} clicker={() => navigate('/mission')}/>
        </div>
    )
}
