...
const MainNoUser = () => {
    ...
    return (
        <div className='noUserMain'>
            <PurpleOutlineDiv boldText={'Create a vender account'} smallText={"Put a listing up for sale and have agents bid on it with the click of a button."} logo={<FaCube className='cube heapPurple' />} css={'purpleOutlineDiv colorDiv firstDiv'} clicker={() => navigate('/signup')}/>
