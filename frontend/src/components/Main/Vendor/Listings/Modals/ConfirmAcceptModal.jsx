...
const ConfirmAcceptModal = ({ closeModal, bid, confirmIcon, cancelIcon }) => {
    ...
    return (
        <div className='camMain textmark'>
            ...
            <p>By accepting this bid of ${bid.offer} you will give the agent the location information for the bid and the ability to message you about it. This will also close the listing for all new bids. Make sure to review the agent's information before accepting.</p>
